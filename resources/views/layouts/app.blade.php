...
<head>
    ...
    <title>{{ config('app.name', 'GamesReviews') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li  class="nav-item"> <a class="nav-link" href="{{ route('image.create') }}">Post</a> </li>
                            <li  class="nav-item"> <a class="nav-link" href="{{ route('like.likes') }}">Favorites</a> </li>
